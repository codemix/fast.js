 ...
 * outside the function declaration. Returns an object containing either an `error` key containing
 * the error object, or a `value` key containing the returned value.
 *
 * ```js
 ...
 * @return {Object}      An object containing either an error or a value.
 */
