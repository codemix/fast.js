...
exports.wrap = function fastWrap (subject) {
  return new Fast(subject);
};
...
Fast.prototype.indexOf = function Fast$indexOf (target) {
  return fast.indexOf(this.value, target);
};

Fast.prototype.lastIndexOf = function Fast$lastIndexOf (target) {
  return fast.lastIndexOf(this.value, target);
};

Fast.prototype.valueOf = function () {
  return this.value;
};

Fast.prototype.toJSON = function () {
  return this.value;
};

Object.defineProprety(Fast.prototype, 'length', {
  get: function () {
